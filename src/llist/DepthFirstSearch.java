...
public class DepthFirstSearch {
     ...
     * @param v vertex on which dfs is to be done
     */
    public void dfsUtilNonRec(Graph graph, int v) {
        this.count = 0;
        this.source = v;
        this.marked = new boolean[graph.getVertexCount()];
        this.edgeTo = new int[graph.getVertexCount()];
     ...
     * @param graph A graph object on which dfs is to be performed same as passed in constructor
     */
    public void dfsFull(Graph graph) {
        this.count = 0;
        this.source = -1;
        this.marked = new boolean[graph.getVertexCount()];
        this.edgeTo = new int[graph.getVertexCount()];
     ...
     * @param v vertex
     */
    private void dfsRec(Graph graph, int v) {
        this.marked[v] = true;
        this.count ++;
     ...
     */
    private void dfsNonRec(Graph graph, int v) {
        // Create a Stack
